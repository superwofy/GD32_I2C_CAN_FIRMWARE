...
#define DEBUG												1																																															// Enable/disable serial debug messages.
#define MAX_CAN_RECV								10																																														// Maximum number of messages to be buffered. For 100ms cycle times, this gives 1s lead time.
